...
public class QuizHTML implements ActionListener{
	String[] questions = {
			...
			"4. Which element is used for or styling HTML5 layout?",
			"5. Apart from <b> tag, what other tag makes text bold ?",
			"6. What tag is used to display a picture in a HTML page?",
			"7. HTML web pages can be read and rendered by _________?",
			"8. Which HTML tag produces the biggest heading?",
			"9. The BODY tag is usually used after ______?",
			"10. The tags in HTML are -?"
	};
	String[] [] options = {
							{"Rasmus Lerdorf","Tim Berners-Lee","Brendan Eich","Sergey Brin"},
							{"</doctype html>","<doctype html>","<doctype html!>","<!doctype html>"},
							{"head tag"," title tag","html tag","body tag"},
							{"CSS","jQuery","JavaScript","PHP"},
							{"<fat>","<strong>","<black>","<emp>"},
							{"picture","image","img","src"},
							{"Compiler","Server","Web Browser","Interpreter"},
							{"<h7>","<h9>","<h4>","<h1>"},
							{"HTML tag","HEAD tag","EM tag","TITLE tag"},
							{"case-sensitive","in upper case","not case sensitive","in lowercase"},
	...
	public QuizHTML() {
		...
		textField.setBackground(new Color (233,206,236));
		...
		textarea.setBackground(new Color (233,206,236));
		...
		answer_labelA.setForeground(new Color (233,206,236));
		answer_labelA.setFont(new Font ("MV Boli", Font.PLAIN,35));
		
		answer_labelB.setBounds(125, 303, 500, 100);
		answer_labelB.setBackground(new Color (50,50,50));
		answer_labelB.setForeground(new Color (233,206,236));
		answer_labelB.setFont(new Font ("MV Boli", Font.PLAIN,35));
		
		answer_labelC.setBounds(125, 403, 500, 100);
		answer_labelC.setBackground(new Color (50,50,50));
		answer_labelC.setForeground(new Color (233,206,236));
		answer_labelC.setFont(new Font ("MV Boli", Font.PLAIN,35));
		
		answer_labelD.setBounds(125, 503, 500, 100);
		answer_labelD.setBackground(new Color (50,50,50));
		answer_labelD.setForeground(new Color (233,206,236));
		...
		number_right.setForeground(new Color (233,206,236));
		...
		percentage.setForeground(new Color (233,206,236));
