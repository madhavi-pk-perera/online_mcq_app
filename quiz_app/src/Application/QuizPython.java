...
public class QuizPython implements ActionListener{
	String[] questions = {
			...
			"4. What happens when '2' == 2 is executed?",
			"5. The % operator returns the ___.",
			"6. The return value for trunc() would be?",
	...
	String[] [] options = {
							...
							{"Object","Function","Attribute","TypeError occurs"},
							{"False","True","ValueError occurs","Encapsulation"},
							{"Quotient","Divisor","Remainder","Percentage"},
							{"bool","float","int","None"},
